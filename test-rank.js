...
test('best two pairs', t => {
  ...
  t.deepEqual(best2Pairs(ss('Kc Kh Kd Ks 7s 7c 7d')), [13, 7, 13], 'quads and trips ok');
  t.deepEqual(best2Pairs(ss('Kc Kh Kd Ks 7s 7c 7d 7h')), [13, 7, 13], 'quads and quads ok');
  t.deepEqual(best2Pairs(ss('Kc Kh Kd Ks 7s 7d 2s 2c 2d 2h')), [13, 7, 13], 'quads quads high-pairs get pairs');
